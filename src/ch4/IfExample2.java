...
//		// 제출) 오답. 왜냐하면 6의 배수인 경우 "3의 배수입니다"만 출력하게 됨. 그러나 6의 배수는 2의 배수이고 3의 배수이기 때문에 오답이다.
...
//		}
		...
		// 풀이2) if-else 활용하여 동일한 결과값 출력(중첩 if 사용 가능, else if 사용 X)
		String resulString = "";
		if(n % 2 != 0 && n % 3 != 0) {
			resulString = "2의 배수도 3의 배수도 아닙니다.";
		} else {
		 ...
		 * 예제2. else if 활용
		 * 
		 * 90점 이상 A, 80점 이상 B, 70점 이상 C, 60점 이상 D, 60점 미만 F를 출력한다.
		 */
		int score = 86;
		if(score >= 90) {
			System.out.println("A 입니다.");
		} else if(score >= 80) {
			System.out.println("B 입니다.");	// 여기
		} else if(score >= 70) {
