...
public class IfExample1 {
	 ...
	 * 여러 줄 주석
	 * 
	 * 변수 작명 규칙(권장 사항으로 필수는 아닙니다)
	 * 1. _를 활용해서 두 단어 이상의 이어진 변수 또는 메서드명을 지정합니다.
	 * 	이유? 변수명에서는 " "를 사용하면 안 됨 Ex) int plus result; (x) -> int plusResult; or int plus_result;
	 * 
	 * 2. 두 단어 이상을 이어붙일 때 변수명 지정 시 대문자 활용할 수 있어요.(낙타 표기법-카멜)
	 ...
	 * 
	 * (절대로 지켜야 할 내용)
	 * 1. 이름의 첫 글자는 숫자를 사용할 수 없습니다.
	 * 2. 이름의 첫 글자는 영문자 혹은 _를 사용해야 하기 때문입니다.
	 * 3. 변수 사이에는 공백을 사용할 수 없었다.
	 * 4. 특수 문자는 _, $만 사용 가능합니다.
	 * 5. 이미 사용하고 있는 예약어(if, for, while 등의 키워드)는 변수명으로 사용할 수 없음
	 * 		(사용할 수 없는 키워드 종류: int, public, static, void, class, for, if, while, ...)
	 * 
	 * 
	 * 변수는 메모리 위치를 나타내는 이름이다.
	 * 
	 */
